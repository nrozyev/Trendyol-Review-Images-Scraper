...
def fetch_product_urls(
        ...
        OFFSET_PARAMETERS=""):
                                ...
                                return (product_urls, OFFSET, OFFSET_PARAMETERS, total_count, next)
...
def append_to_json_file(filepath, category, product_urls):
    ...
    if isinstance(data, dict) and category not in data:
        ...
        data[category] = list(set(data[category]).union(product_urls))
    else:
...
if __name__ == "__main__":
    ...
    for url in urls_for_categories:
        ...
        product_urls, OFFSET, OFFSET_PARAMETERS, total_count, next = fetch_product_urls(category)
        ...
        while True:
            PI = PI +1
            product_urls, OFFSET, OFFSET_PARAMETERS, total_count, next = fetch_product_urls(category, PI=PI, OFFSET=OFFSET, OFFSET_PARAMETERS=OFFSET_PARAMETERS)
